...
TreeNode.prototype = {
    ...
    isFolded: function(){
        ...
        //return true;
        return this.childs[0].selfElement.className != "nodebody-visible";
    }
};
//=======================================以上是封装TreeNode的代码=============================================
...
//=============================================事件绑定区===============================================
// 创建根节点对应的TreeNode对象
var root = new TreeNode({parent: null, childs: [], data: "英雄联盟", selfElement: document.getElementsByClassName("nodebody-visible")[0]});
...
//=======================================Demo展示区==================================================
//动态生成Demo树
root.addChild("德玛西亚盖伦").addChild("诺克萨斯之手").addChild("蛮族之王泰达米尔");
root.childs[0].addChild("致命打击").addChild("勇气").addChild("审判").addChild("德玛西亚之力").addChild("坚韧").toggleFold();
root.childs[0].childs[4].addChild("人在塔在").toggleFold();
root.childs[1].addChild("大杀四方").addChild("肢残打击").addChild("无情铁手").toggleFold();
root.childs[2].addChild("战斗狂怒").addChild("嗜血杀手").addChild("无尽怒火").toggleFold();
root.childs[2].childs[2].addChild("我的大刀早已饥渴难耐了").toggleFold();
//初始化查询Demo值
document.getElementById("searchText").value = "致命打击";
//==================================================================================================
